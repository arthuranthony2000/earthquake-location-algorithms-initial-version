...
% Executar HybridGWO
tic
[f_hgwo, s_estimated_hgwo, h_estimated_hgwo] = HybridGWO(fobj, tobs, nVar, lb, ub, maxIter, wolvesNo, cx, cy, cz, ns, v, cross_constant, mutation_constant, sigma, tournament_size);
time_hgwo = toc;
