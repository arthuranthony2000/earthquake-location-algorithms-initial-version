...
for j = 1:num_hipocentros
    ...
    plot3(s0(j, 1), s0(j, 2), s(3), 'rpentagram', 'MarkerFaceColor', 'red', 'MarkerSize', 10, 'DisplayName','Solução Inicial');
...
sgtitle('Curva de Nível', 'FontSize', 16, 'FontWeight', 'bold');