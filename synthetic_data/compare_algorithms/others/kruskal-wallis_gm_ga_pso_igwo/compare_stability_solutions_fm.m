...
fprintf('H0: Não há diferença entre os custos médios nos eventos em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
fprintf('H1: Há diferença entre os custos médios nos eventos em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
fprintf('Valor-p: %.4f\n', p);
...
if p < alpha
    fprintf('Rejeitamos H0. Há diferença entre os custos médios nos eventos em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
    ...
    fprintf('Não rejeitamos H0. Não há diferença entre os custos médios nos eventos em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
end
...
legend('Custo Estável Gauss-Newton com Multi-Start', 'Custo Estável Algoritmo Genético', 'Custo Estável Nuvem de Partículas', 'Custo Estável Otimização por Lobos Cinzentos Aprimorado');
