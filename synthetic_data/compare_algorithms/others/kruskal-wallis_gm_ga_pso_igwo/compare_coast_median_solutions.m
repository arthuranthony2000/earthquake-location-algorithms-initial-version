...
legend('Custo Médio Gauss-Newton com Multi-Start', 'Custo Médio Algoritmo Genético', 'Custo Médio Algoritmo de Otimização por Enxame de Partículas', 'Custo Médio Otimização por Lobos Cinzentos Aprimorado');
...
fprintf('H0: Não há diferença entre os custos das soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
fprintf('H1: Há diferença entre os custos das soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético e Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
fprintf('Valor-p: %.4f\n', p);
...
if p < alpha
    fprintf('Rejeitamos H0. Há diferença entre os custos das soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
    ...
    elseif norm_diff_pso < norm_diff_gwo
        ...
        fprintf('Otimização por Lobos Cinzentos Aprimorado teve sua solução média mais próxima da solução verdadeira.\n');
    end
else
    fprintf('Não rejeitamos H0. Não há diferença entre os custos das soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
end
