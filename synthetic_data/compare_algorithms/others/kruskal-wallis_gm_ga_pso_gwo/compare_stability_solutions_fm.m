...
fprintf('H0: Não há diferença entre os custos médios nos eventos em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
fprintf('H1: Há diferença entre os custos médios nos eventos em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
fprintf('Valor-p: %.4f\n', p);
...
if p < alpha
    fprintf('Rejeitamos H0. Há diferença entre os custos médios nos eventos em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
    ...
    elseif sum_v_fm_pso < sum_v_fm_gwo
        ...
        fprintf('Otimização por Lobos Cinzentos estabilizou com menor custo para o mínimo da função.\n');
    end
else
    fprintf('Não rejeitamos H0. Não há diferença entre os custos médios nos eventos em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
end
...
legend('Custo Estável Gauss-Newton com Multi-Start', 'Custo Estável Algoritmo Genético', 'Custo Estável Nuvem de Partículas', 'Custo Estável Otimização por Lobos Cinzentos');
