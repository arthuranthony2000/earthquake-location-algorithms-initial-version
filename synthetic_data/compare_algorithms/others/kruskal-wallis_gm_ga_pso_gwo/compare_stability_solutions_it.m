...
fprintf('H0: Não há diferença entre as iterações em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
fprintf('H1: Há diferença entre as iterações em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
fprintf('Valor-p: %.4f\n', p);
...
if p < alpha
    fprintf('Rejeitamos H0. Há diferença entre as iterações em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
    ...
    elseif sum_it_pso < sum_it_gwo
        ...
        fprintf('Otimização por Lobos Cinzentos estabilizou mais rapidamente para o mínimo da função.\n');
    end
else
    fprintf('Não rejeitamos H0. Não há diferença entre as iterações em que estabilizaram o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
end
...
legend('Iteração Estável Gauss-Newton com Multi-Start', 'Iteração Estável Algoritmo Genético', 'Iteração Estável Nuvem de Partículas', 'Iteração Estável Otimização por Lobos Cinzentos');
