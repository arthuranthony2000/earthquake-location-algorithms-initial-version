...
% Vetor das somas dos custos das soluções de Otimização por Lobos Cinzentos
fss_gwo = zeros(1, 4);
...
fprintf('H0: Não há diferença entre a soma dos custos das soluções obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
fprintf('H1: Há diferença entre a soma dos custos das soluções obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
fprintf('Valor-p: %.4f\n', p);
...
if p < alpha
    fprintf('Rejeitamos H0. Há diferença entre as somas dos custos das soluções obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
    ...
    elseif sum_fss_pso < sum_fss_gwo
        ...
        fprintf('Otimização por Lobos Cinzentos decresceu o desajuste mais rapidamente para o mínimo da função.\n');
    end
else
    fprintf('Não rejeitamos H0. Não há diferença entre as somas dos custos das soluções obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
end
...
legend('Decrescimento do Gauss-Newton com Multi-Start', 'Decrescimento do Algoritmo Genético', 'Decrescimento da Nuvem de Partículas', 'Decrescimento do Algoritmo de Otimização por Lobos Cinzentos');
