...
plot3(mss_gwo(1:3:end), mss_gwo(2:3:end), mss_gwo(3:3:end), 'bpentagram', 'MarkerFaceColor', 'blue', 'MarkerSize', 8, 'DisplayName', 'Hipocentro Estimado para o Otimização por Lobos Cinzentos Hibridizado');
