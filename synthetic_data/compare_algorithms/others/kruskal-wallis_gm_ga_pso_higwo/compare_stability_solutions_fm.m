...
legend('Custo Estável Gauss-Newton com Multi-Start', 'Custo Estável Algoritmo Genético', 'Custo Estável Nuvem de Partículas', 'Custo Estável Otimização por Lobos Cinzentos Hibridizado');
