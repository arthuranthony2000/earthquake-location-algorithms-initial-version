...
if p < alpha
    ...
    elseif sum_fss_pso < sum_fss_gwo
        ...
        fprintf('Otimização por Lobos Cinzentos Hibridizado decresceu o desajuste mais rapidamente para o mínimo da função.\n');
    end
else
...
legend('Decrescimento do Gauss-Newton com Multi-Start', 'Decrescimento do Algoritmo Genético', 'Decrescimento da Nuvem de Partículas', 'Decrescimento do Algoritmo de Otimização por Lobos Cinzentos Hibridizado');
