...
tp = @(x_s, x_c, y_s, y_c, z_s, z_c) sqrt((x_s - x_c)^2 + (y_s - y_c)^2 + (z_s - z_c)^2) / vp;
ts = @(x_s, x_c, y_s, y_c, z_s, z_c) sqrt((x_s - x_c)^2 + (y_s - y_c)^2 + (z_s - z_c)^2) / vs;
...
tobs_p = [tp(s1(1), event(1), s1(2), event(2), s1(3), event(3)), tp(s2(1), event(1), s2(2), event(2), s2(3), event(3))];
tobs_s = [ts(s1(1), event(1), s1(2), event(2), s1(3), event(3)), ts(s2(1), event(1), s2(2), event(2), s2(3), event(3))];

v_obs = @(s1, s2, c, tobs) (sqrt((s1(1) - c(1))^2 + (s1(2) - c(2))^2 + (s1(3) - fixed_z)^2) - sqrt((s2(1) - c(1))^2 + (s2(2) - c(2))^2 + (s2(3) - fixed_z)^2)) / (tobs(1) - tobs(2));
...
best_coordinates = [col(2), row(2)]; % Use grid coordinates
