...
save('tobs_p_out', 'tobs_p');
save("-v7", "tobs_p_out.mat", "tobs_p");

save('tobs_s_out', 'tobs_s');
save("-v7", "tobs_s_out.mat", "tobs_s");

save('st_out', 'st');
save("-v7", "st_out.mat", "st");

save('vp_out', 'vp');
save("-v7", "vp_out.mat", "vp");

save('vs_out', 'vs');
save("-v7", "vs_out.mat", "vs");

save('event_out', 'event');
save("-v7", "event_out.mat", "event");
