...
figure;
hold on;
plot(tempo, tobs_ss, 'ok', 'MarkerFaceColor', 'k', 'LineWidth', 2);
plot(tempo, tobs_gm, 'or', 'MarkerFaceColor', 'r', 'LineWidth', 2);
plot(tempo, tobs_ga, 'og', 'MarkerFaceColor', 'g', 'LineWidth', 2);
plot(tempo, tobs_pso, 'oy', 'MarkerFaceColor', 'y', 'LineWidth', 2);
plot(tempo, tobs_gwo, 'ob', 'MarkerFaceColor', 'b', 'LineWidth', 2);
...
legend('Real Data', 'Gauss-Newton with Multi-Start', 'Genetic Algorithm', 'Particle Swarm Optimization', 'Hybrid Grey Wolf Optimizer', 'Location', 'Best');

% Defina o título do gráfico
title('Comparison of Calculated Data');
...
fprintf('H0: Não há diferença entre os dados calculados das soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Hibridizado.\n');
fprintf('H1: Há diferença entre os dados calculados das soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Hibridizado.\n');
fprintf('Valor-p: %.4f\n', p);
...
if p < alpha
    fprintf('Rejeitamos H0. Há diferença entre os dados calculados das soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Hibridizado.\n');
    ...
    if norm_diff_gwo < norm_diff_gm && norm_diff_gwo < norm_diff_ga && norm_diff_gwo < norm_diff_pso
        fprintf('Otimização por Lobos Cinzentos Hibridizado obteve o melhor ajuste dos dados.\n');
