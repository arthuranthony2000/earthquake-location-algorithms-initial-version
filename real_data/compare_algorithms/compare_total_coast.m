...
legend('Gauss-Newton with Multi-Start', 'Genetic Algorithm', 'Particle Swarm Optimization', 'Hybrid Grey Wolf Optimization', 'Location', 'Best');

title('Comparison of Total Cost Objective Function');
