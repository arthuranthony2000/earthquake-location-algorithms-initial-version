...
legend('Iteração Estável Gauss-Newton com Multi-Start', 'Iteração Estável Algoritmo Genético', 'Iteração Estável Nuvem de Partículas', 'Iteração Estável Otimização por Lobos Cinzentos Hibridizado');
