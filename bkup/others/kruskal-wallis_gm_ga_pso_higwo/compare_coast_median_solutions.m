...
legend('Custo Médio Gauss-Newton com Multi-Start', 'Custo Médio Algoritmo Genético', 'Custo Médio Algoritmo de Otimização por Enxame de Partículas', 'Custo Médio Otimização por Lobos Cinzentos Hibridizado');
