...
legend('Dado Real', 'Gauss-Newton com Multi-Start', 'Algoritmo Genético', 'Nuvem de Partículas', 'Otimização por Lobos Cinzentos Aprimorado');
...
fprintf('H0: Não há diferença entre os dados calculados das soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
fprintf('H1: Há diferença entre os dados calculados das soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
fprintf('Valor-p: %.4f\n', p);
...
if p < alpha
    fprintf('Rejeitamos H0. Há diferença entre os dados calculados das soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
    ...
    if norm_diff_gwo < norm_diff_gm && norm_diff_gwo < norm_diff_ga && norm_diff_gwo < norm_diff_pso
        fprintf('Otimização por Lobos Cinzentos Aprimorado obteve o melhor ajuste dos dados.\n');
