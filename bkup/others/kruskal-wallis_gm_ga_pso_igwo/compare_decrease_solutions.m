...
% Vetor das somas dos custos das soluções de Otimização por Lobos Cinzentos Aprimorado
fss_gwo = zeros(1, 4);
...
fprintf('H0: Não há diferença entre a soma dos custos das soluções obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
fprintf('H1: Há diferença entre a soma dos custos das soluções obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
fprintf('Valor-p: %.4f\n', p);
...
if p < alpha
    fprintf('Rejeitamos H0. Há diferença entre as somas dos custos das soluções obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
    ...
    elseif sum_fss_pso < sum_fss_gwo
        ...
        fprintf('Otimização por Lobos Cinzentos Aprimorado decresceu o desajuste mais rapidamente para o mínimo da função.\n');
    end
else
    fprintf('Não rejeitamos H0. Não há diferença entre as somas dos custos das soluções obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos Aprimorado.\n');
end
...
legend('Decrescimento do Gauss-Newton com Multi-Start', 'Decrescimento do Algoritmo Genético', 'Decrescimento da Nuvem de Partículas', 'Decrescimento do Algoritmo de Otimização por Lobos Cinzentos Aprimorado');
