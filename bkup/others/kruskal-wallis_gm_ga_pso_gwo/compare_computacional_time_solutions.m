...
fprintf('H0: Não há diferença entre o tempo computacional para obter as soluções com o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
fprintf('H1: Há diferença entre o tempo computacional para obter as soluções com o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
fprintf('Valor-p: %.4f\n', p);
...
if p < alpha
    fprintf('Rejeitamos H0. Há diferença entre os tempos computacionais para obter as soluções com o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
    ...
    elseif sum_time_pso < sum_time_gwo
        ...
        fprintf('Otimização por Lobos Cinzentos teve o menor custo computacional.\n');
    end
else
    fprintf('Não rejeitamos H0. Não há diferença entre os tempos computacionais para obter as soluções com o Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
end
