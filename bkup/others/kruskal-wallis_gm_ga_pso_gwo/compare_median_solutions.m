...
fprintf('H0: Não há diferença entre as soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
fprintf('H1: Há diferença entre as solução médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
fprintf('Valor-p: %.4f\n', p);
...
if p < alpha
    fprintf('Rejeitamos H0. Há diferença entre as soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
    ...
    fprintf('Não rejeitamos H0. Não há diferença entre as soluções médias obtidas pelo Gauss-Newton com Multi-Start, Algoritmo Genético, Nuvem de Partículas e Otimização por Lobos Cinzentos.\n');
end
...
plot3(mss_gwo(1:3:end), mss_gwo(2:3:end), mss_gwo(3:3:end), 'bpentagram', 'MarkerFaceColor', 'blue', 'MarkerSize', 8, 'DisplayName', 'Hipocentro Estimado para o Otimização por Lobos Cinzentos');
